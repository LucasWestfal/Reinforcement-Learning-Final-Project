...
| -------- | ----- | ----------- | - |
| `hidden_size` | -    | [128, 128]    | Lorem
| `BATCH_SIZE` | -     |    4096     | Mais acurácia na estimação dos gradientes; acelerar convergência.
| `EXPL_NOISE` | -     |   0.3       | LOREM
| `MEMORY_SIZE` | -    |   3,000,000   | Evitar overfitting
| `LEARN_STEP`  | -    | 100         | lorem
| `max_steps`   | 2,000,000  | 400,000     | Limitações computacionais, pelo aumento do número de passos de evolução
| `learning_delay` | - | 10,000      | lorem
| `evo_steps`   | -    | 100,000     | lorem
